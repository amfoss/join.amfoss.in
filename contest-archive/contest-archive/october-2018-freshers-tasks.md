...
\
One possible approach you could take is like :<br>

* Take the input as a text file or a PDF.<br>
* Parse the file using python.<br>
* Split the phrases using .split() function in python.<br>
* Add a small functionality to do google search via terminal/command line.<br>
* Do a double quote search in Google through the CMD<br>
* Produce the results with the matches and print it out.<br>
...
* Create a twitter app and generate key<br>
* Store Credentials of the user in a separate file “tokens.py”<br>
* OAuth Authentication where you would import the tokens and using tweepy.AuthHandler complete the authentication<br>
* Get input from user about the tweet about to be send<br>
